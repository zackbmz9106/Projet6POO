...
set @have_innodb = (select count(engine)
...
(
    Host         char(60) binary                        DEFAULT ''  NOT NULL,
    User         char(80) binary                        DEFAULT ''  NOT NULL,
    Role         char(80) binary                        DEFAULT ''  NOT NULL,
    Admin_option enum ('N','Y') COLLATE utf8_general_ci DEFAULT 'N' NOT NULL,
    UNIQUE (Host, User, Role)
) engine = MyISAM
  CHARACTER SET utf8
  COLLATE utf8_bin comment ='Granted roles';
...
SET @str = IF(@have_csv = 'YES',
              'CREATE TABLE IF NOT EXISTS slow_log (start_time TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, user_host MEDIUMTEXT NOT NULL, query_time TIME(6) NOT NULL, lock_time TIME(6) NOT NULL, rows_sent INTEGER NOT NULL, rows_examined INTEGER NOT NULL, db VARCHAR(512) NOT NULL, last_insert_id INTEGER NOT NULL, insert_id INTEGER NOT NULL, server_id INTEGER UNSIGNED NOT NULL, sql_text MEDIUMTEXT NOT NULL, thread_id BIGINT(21) UNSIGNED NOT NULL, rows_affected INTEGER NOT NULL) engine=CSV CHARACTER SET utf8 comment="Slow log"',
              'SET @dummy = 0');
...
(
  ...
  CHARACTER SET utf8
  COLLATE utf8_bin comment ='Statistics on Tables';
...
(
  ...
  CHARACTER SET utf8
  COLLATE utf8_bin comment ='Statistics on Columns';
...
(
  ...
  CHARACTER SET utf8
  COLLATE utf8_bin comment ='Statistics on Indexes';
