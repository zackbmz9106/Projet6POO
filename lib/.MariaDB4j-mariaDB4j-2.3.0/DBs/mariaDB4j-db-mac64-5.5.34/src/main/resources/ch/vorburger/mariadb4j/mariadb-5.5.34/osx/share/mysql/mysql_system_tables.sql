...
(
  ...
  CHARACTER SET utf8
  COLLATE utf8_bin comment ='Database privileges';
...
(
  ...
  CHARACTER SET utf8
  COLLATE utf8_bin comment ='Host privileges;  Merged with database privileges';
...
(
  ...
  CHARACTER SET utf8
  COLLATE utf8_bin comment ='User defined functions';
...
(
  ...
  CHARACTER SET utf8
  COLLATE utf8_general_ci comment ='MySQL plugins';
...
(
  ...
  CHARACTER SET utf8
  COLLATE utf8_bin comment ='Table privileges';
...
(
  ...
  CHARACTER SET utf8
  COLLATE utf8_bin comment ='Procedure privileges';

-- Create general_log if CSV is enabled.

SET @str = IF(@@have_csv = 'YES',
              'CREATE TABLE IF NOT EXISTS general_log (event_time TIMESTAMP(6) NOT NULL, user_host MEDIUMTEXT NOT NULL, thread_id INTEGER NOT NULL, server_id INTEGER UNSIGNED NOT NULL, command_type VARCHAR(64) NOT NULL, argument MEDIUMTEXT NOT NULL) engine=CSV CHARACTER SET utf8 comment="General log"',
              'SET @dummy = 0');
...
(
    ...
    inserts   BIGINT UNSIGNED NOT NULL,
    updates   BIGINT UNSIGNED NOT NULL,
    deletes   BIGINT UNSIGNED NOT NULL,
    schemaops BIGINT UNSIGNED NOT NULL,
    PRIMARY KEY (epoch)
) ENGINE = MYISAM;
...
(
    Host         char(60) binary DEFAULT '' NOT NULL,
    User         char(16) binary DEFAULT '' NOT NULL,
    Proxied_host char(60) binary DEFAULT '' NOT NULL,
    Proxied_user char(16) binary DEFAULT '' NOT NULL,
  ...
  CHARACTER SET utf8
  COLLATE utf8_bin comment ='User proxy privileges';
